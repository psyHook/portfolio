...
const AboutMe = () => {
  return (
    <div className="container-fluid aboutme-wall">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-xm-12 about-p">
            ...
            <p className="fs-2">
              ...
              about learning and technology, self-taught, responsible and eager
              to continue growing as a professional. I currently work with MERN
              Stack.
            </p>
